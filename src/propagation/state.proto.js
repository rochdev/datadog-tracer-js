...
(function(global, factory) { /* global define, require, module */
    ...
    $root.TracerState = (function() {
         ...
         * @typedef TracerState$Properties
         * @type {Object}
         ...
         * @exports TracerState
         * @constructor
         * @param {TracerState$Properties=} [properties] Properties to set
         */
         ...
         * @param {TracerState$Properties} message TracerState message or plain object to encode
        ...
        /**
         * Creates a TracerState message from a plain object. Also converts values to their respective internal types.
         * This is an alias of {@link TracerState.fromObject}.
         * @function
         * @param {Object.<string,*>} object Plain object
         * @returns {TracerState} TracerState
         */
        TracerState.from = TracerState.fromObject;
        ...
        /**
         * Creates a plain object from this TracerState message. Also converts values to other types if specified.
         * @param {$protobuf.ConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        TracerState.prototype.toObject = function toObject(options) {
